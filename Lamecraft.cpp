...
#include "LameCraft/GlobalFunctions.h"
#include "LameCraft/StateLoad.h"
#include "LameCraft/Panorama.h"
...
int main()
{
	...
	//new active state
	StateLoad *statePlay = new StateLoad();
	statePlay->Init();
