...
namespace Aurora
{
	namespace Graphics
	{
		...
		void RenderManager::InitDebugFont()
		{
			...
			engFont = intraFontLoad("Assets/Fonts/ltn4.pgf",INTRAFONT_STRING_UTF8);
			//rusFont = intraFontLoad("Assets/Fonts/eng_letters.pgf",INTRAFONT_CACHE_ASCII);
			//jpnFont = intraFontLoad("Assets/Fonts/jpn0.pgf",INTRAFONT_STRING_UTF8);
			/*ltn8Font = intraFontLoad("Assets/Fonts/ltn0.pgf",INTRAFONT_CACHE_ASCII);
			aribFont = intraFontLoad("Assets/Fonts/arib.pgf",INTRAFONT_CACHE_ASCII);
			kr0Font = intraFontLoad("Assets/Fonts/kr0.pgf",INTRAFONT_CACHE_ASCII);
			chmFont = intraFontLoad("Assets/Fonts/gb3s1518.bwfon",INTRAFONT_CACHE_ASCII);*/
		...
		void RenderManager::japanFont(bool isJapanFontSelected)
		{
			
			if(isJapanFontSelected == true)
			{
				intraFontUnload(engFont);
				engFont = intraFontLoad("Assets/Fonts/jpn0.pgf",INTRAFONT_STRING_UTF8);
			}
			if(isJapanFontSelected == false)
			{
				intraFontUnload(engFont);
				engFont = intraFontLoad("Assets/Fonts/ltn4.pgf",INTRAFONT_STRING_UTF8);
			}
        ...
        void RenderManager::SetFont(int type)
		{
			...
			switch(type)
			{
			    ...
			    case 2: debugFont = engFont; fontVerticalShift = -4; break;
			    case 3: debugFont = engFont; fontVerticalShift = -4; break;
			}
		}
