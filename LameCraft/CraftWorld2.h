...
public:
	...
	const char* getBlockTrans(int id);
	const char* getItemTrans(int id);
	...
	void updatePlayerPosition(const Vector3& playerPos);
	...
	void drawFull3DItemInv(int i,float light);
	void drawFull3DItem(int i,float light);
	void drawFull3DItemFixed(int i, bool lightStatus, float light);
	...
	int groundHeightFromBottomHell (const int x, const int y, const int z);
	...
	void SpawnPigman(float xx, float yy, float zz);
	void DestroyPigman(int id);
	void DestroyAllPigmans();
	
	void SpawnWitherSkeleton(float xx, float yy, float zz);
	void DestroyWitherSkeleton(int id);
	void DestroyAllWitherSkeletons();
	
	void SpawnSkeleton(float xx, float yy, float zz);
	void DestroySkeleton(int id);
	...
	void SpawnVillager(float xx, float yy, float zz);
	void DestroyVillager(int id);
	
	void SpawnWolf(float xx, float yy, float zz);
	void DestroyWolf(int id);
    ...
    float spawnPigmansTimer;
    float spawnWitherSkeletonsTimer;
	float spawnSkeletonsTimer;
    ...
    std::vector<Pigman*> mPigmans;
    std::vector<WitherSkeleton*> mWitherSkeletons;
	...
	std::vector<Villager*> mVillagers;
	std::vector<Wolf*> mWolfs;
	...
	// for Wolfs
	TexturesPSPVertex *wolfManeVertices;
	TexturesPSPVertex *wolfBodyVertices;
	TexturesPSPVertex *wolfTailVertices;
	TexturesPSPVertex *wolfLegVertices;
	
	// for villager
	TexturesPSPVertex *villagerLegVertices;
	TexturesPSPVertex *villagerBodyVertices;
	TexturesPSPVertex *villagerHeadVertices;
	TexturesPSPVertex *villagerHandVertices;
	TexturesPSPVertex *villagerMidHandVertices;
	TexturesPSPVertex *villagerNosesVertices;
	TexturesPSPVertex *villagerBodyWearVertices;
...
private:
	...
	// Temporary variables for return references (needed for legacy code compatibility)
	static block_t m_tempBlock;
	static block_t m_tempBlockSettings;
