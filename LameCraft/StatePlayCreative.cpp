...
void StatePlayCreative::InitParametric(bool makeDungeons, bool makeBonus,unsigned int seed_1,int worldType, char gameMode, bool nether)
{
	WaitLoad = true;
    //set render manager instance
    mRender = RenderManager::InstancePtr();
...
void StatePlayCreative::LoadMap(std::string fileName,bool compressed)
{
    ...
    if(compressed)
    {
        mWorld->LoadCompressedWorld(saveFileName, TeleportLoad, saveFileName); //Poner mGlobalFun->teleported
...
void StatePlayCreative::CraftItem3x3()
{
    ...
    if(enableMainCraftBody)
    {
        switch(result)
        {
		case 1664:	//quartz ore recipes
			if((craftSlotId3[0] == 416 && craftSlotId3[1] == 416 && craftSlotId3[3] == 416 && craftSlotId3[4] == 416) || 
			(craftSlotId3[1] == 416 && craftSlotId3[2] == 416 && craftSlotId3[4] == 416 && craftSlotId3[5] == 416) ||
			(craftSlotId3[3] == 416 && craftSlotId3[4] == 416 && craftSlotId3[6] == 416 && craftSlotId3[7] == 416) || 
			(craftSlotId3[4] == 416 && craftSlotId3[5] == 416 && craftSlotId3[7] == 416 && craftSlotId3[8] == 416))
			{
				craftItemId3 = 216;
				craftItemSt3 = 1;
				craftItemAm3 = 1;
		...
		case 1672:	//glowstone recipes
			if((craftSlotId3[0] == 418 && craftSlotId3[1] == 418 && craftSlotId3[3] == 418 && craftSlotId3[4] == 418) || 
			(craftSlotId3[1] == 418 && craftSlotId3[2] == 418 && craftSlotId3[4] == 418 && craftSlotId3[5] == 418) ||
			(craftSlotId3[3] == 418 && craftSlotId3[4] == 418 && craftSlotId3[6] == 418 && craftSlotId3[7] == 418) || 
			(craftSlotId3[4] == 418 && craftSlotId3[5] == 418 && craftSlotId3[7] == 418 && craftSlotId3[8] == 418))
			{
				craftItemId3 = 225;
				craftItemSt3 = 1;
				craftItemAm3 = 1;
        ...
        break;
		case 482: //shield
            if(craftSlotId3[0] == 34 && craftSlotId3[1] == 278 && craftSlotId3[2] == 34 && craftSlotId3[3] == 34 && craftSlotId3[4] == 34 && craftSlotId3[5] == 34 && craftSlotId3[7] == 34)
            {
                craftItemId3 = 415;
                craftItemAm3 = 150;
                craftItemSt3 = false;
        ...
        break;
		case 1208:
            if(craftSlotId3[0] == 155 && craftSlotId3[1] == 278 && craftSlotId3[2] == 155 && craftSlotId3[3] == 155 && craftSlotId3[4] == 155 && craftSlotId3[5] == 155 && craftSlotId3[7] == 155)
            {
                craftItemId3 = 415;
                craftItemAm3 = 150;
                craftItemSt3 = false;
        ...
        break;
		case 1214:
            if(craftSlotId3[0] == 156 && craftSlotId3[1] == 278 && craftSlotId3[2] == 156 && craftSlotId3[3] == 156 && craftSlotId3[4] == 156 && craftSlotId3[5] == 156 && craftSlotId3[7] == 156)
            {
                craftItemId3 = 415;
                craftItemAm3 = 150;
                craftItemSt3 = false;
...
void StatePlayCreative::HandleEvents(StateManager* sManager)
{
    ...
    if(menuState == 0)//game state
    {
        ...
        if(invEn == false && craft3xEn == false && chestEn == false && furnaceEn == false)
        {
			...
			{
				if (mWorld->invId[27+barPosition] == Bow0::getID() || mWorld->invId[27+barPosition] == Bow1::getID() || mWorld->invId[27+barPosition] == Bow2::getID() || mWorld->invId[27+barPosition] == Bow3::getID()) //arco
                {
					if (RecoidBow == false)
					{
						for(int i = 27; i < 36; i++)
						{
							if(mWorld->invId[i] == Arrow::getID())
							{
								...
								else if(tickBow >= 2.0 && tickBow < 3.0)
								{
			...
			else
			{
				if (AtackBow == true)
				{
					if (mWorld->invId[27+barPosition] == Bow1::getID() || mWorld->invId[27+barPosition] == Bow2::getID() || mWorld->invId[27+barPosition] == Bow3::getID()) //arco
					{
						for(int i = 27; i < 36; i++)
						{
							if(mWorld->invId[i] == Arrow::getID())
							{
								...
								else if (tickBow <= 2.9f)
								{
									changeYBow = 1.0f;
								}
								else if (tickBow >= 3.0f)
								{
									changeYBow = 0.3f;
								}
								AtackBow = false;
                ...
                for(float i = 0; i < 5.25f; i+=0.15f)
                {
                    ...
                    if(mWorld->BlockEditable(testPos.x,testPos.y,testPos.z) && testBox.contains(testPos))
                    {
                        ...
                        if (selectedBlock == CraftingTable::getID()) // open crafting table menu
                        {
                            ...
                            upEn == true ? selectInvSprite->SetPosition(204 + (invXPosition * 18),78+(invYPosition * 18)) : selectInvSprite->SetPosition(168+(invXPosition * 36),149+(invYPosition * 36));
                        ...
                        if (selectedBlock == ChestBlock1::getID() || selectedBlock == ChestBlock2::getID() || selectedBlock == ChestBlock3::getID() || selectedBlock == ChestBlock4::getID())
                        {
                            ...
                            if(chestId != -1)
                            {
                                ...
                                upEn == true ? selectInvSprite->SetPosition(168 + (invXPosition * 18),78+(invYPosition * 18)) : selectInvSprite->SetPosition(168+(invXPosition * 18),149+(invYPosition * 18));
                        ...
                        if (selectedBlock == FurnaceOff::getID() || selectedBlock == FurnaceOn::getID())
                        {
                            ...
                            if(furnaceId != -1)
                            {
                                ...
                                upEn == true ? selectInvSprite->SetPosition(222,78+(invYPosition * 36)) : selectInvSprite->SetPosition(168+(invXPosition * 18),149+(invYPosition * 18));
        ...
        if(mSystemMgr->KeyHold(PSP_CTRL_TRIANGLE)) // if you press R
        {
            if(invEn == true)
            {
		...
		if(keyPressed(InputHelper::Instance()->getButtonToAction(13))) // if you press R	//experiencia
        {
			creativePage = 0;
			creativePlace --;
			if(creativePlace < 0)
        ...
        if(keyPressed(InputHelper::Instance()->getButtonToAction(9)))
        {
            ...
            else
            {
                if(craft3xEn == 1)
                {
                    ...
                    selectInvSprite->SetPosition(204 + (invXPosition * 18),78+(invYPosition * 18));
                }
        ...
        if(keyPressed(InputHelper::Instance()->getButtonToAction(10)))
        {
            ...
            if (upEn == 0)
            {
                if (invYPosition == 0 && invEn == false)
                {
				    ...
				    if(craft3xEn == 1)
                    {
                        if(invXPosition >= 2 && invXPosition <= 4)
                        {
                            invXPosition -= 2;
                            invYPosition = 2;
                            selectInvSprite->SetPosition(204 + (invXPosition * 18),78+(invYPosition * 18));
...
{	
    if(menuState == 0)//game state
    {
        ...
        if(dt < 0.1f)
        {
            ...
            {
				//player in portals
				if(mWorld->PlayerInHellPortal(legsPosition) && !WaitLoad)
				{
					tickTp += dt;
		...
		// Fov dinamico de camara
		float originalFov = mWorld->mainOptions.fov;
		float sprintFov = originalFov + 20;
		float fovTransitionSpeed = 0.2f;

		if(sprint)  // Si el jugador está corriendo
		{
			if (mRender->fovv < sprintFov)
			{
				mRender->fovv += (sprintFov - mRender->fovv) * fovTransitionSpeed;
				if (mRender->fovv > sprintFov)
				{
					mRender->fovv = sprintFov;
				}
			}
		}else{
			if (mRender->fovv > originalFov)
			{
				mRender->fovv -= (mRender->fovv - originalFov) * fovTransitionSpeed;
				if (mRender->fovv < originalFov)
				{
					mRender->fovv = originalFov;
				}
			}
		}
        ...
        if(isWalking && walkingOnGround && (!footInWater || !footInLava))
        {
			...
			float bobSineX = sinf(bobCycle - (PI / 2.0f) + PI) / 50;
			float bobSineY = cosf(bobCycle - (PI / 2.0f) + PI) / 30;	//25
			
			Vector3 localOffset(bobSineX, bobSineY, 0.0f);
			Vector3 viewDirection = fppCam->m_vView - fppCam->m_vPosition;
			viewDirection.normalize();
			Vector3 right = Vector3::cross(viewDirection, fppCam->m_vUpVector);
			right.normalize();

			Vector3 globalOffset = right * localOffset.x + fppCam->m_vUpVector * localOffset.y;
...
void StatePlayCreative::Draw(StateManager* sManager)
{
    ...
    if(mWorld->mainOptions.detailedSky == 1 && mWorld->currentWorld == 0)
    {
                ...
                if(TestPigman->toDestroy == true || (TestPigman->killed == true && TestPigman->deathTimer <= 0.0f))
                {
                    if(TestPigman->killed == true)
                    {
                        if(TestPigman->lastKickType != 2) // kicked by player or other death
                        {
                            ...
                            if(amountTwo != 0) mWorld->DropThis(RottenFlesh::getID(),amountTwo,true,Vector3(TestPigman->position.x,TestPigman->position.y+0.3f,TestPigman->position.z));
							
							int amountThr = rand() % 1;
                            if(amountThr != 0) mWorld->DropThis(GoldenBar::getID(),amountThr,true,Vector3(TestPigman->position.x,TestPigman->position.y+0.3f,TestPigman->position.z));
                        }
                    }
    ...
    if(mWorld->mainOptions.guiDrawing == 1)
	{
		...
		if(mWorld->invId[27 + barPosition] == -1)	// Render hand on the screen
		{
			...
			// Traslación
			ScePspFVector3 move = { 0.27f + cubeBob + shift_x + sinf(animDest) * -0.3f, -0.35f + shift_y + cubeBob2 + changeY, -0.34f };
			sceGumTranslate(&move);
			
			// Rotacion y escala
			sceGumRotateX(-0.72f + sinf(animDest) * -0.8f);
			sceGumRotateY(3.45f + sinf(animDest) * 0.2f);
			sceGumRotateZ(0.35f);
		...
		if(mWorld->invId[27+barPosition] >= 250)	// Render items on the screen
		{
			...
			// Traslacion
			ScePspFVector3 move = {0.523f + cubeBob + shift_x +sinf(animDest) * - 0.25, -0.24f + cubeBob2 + idle_y + shift_y + changeY, -0.6f};//-0.17
			sceGumTranslate(&move); //-0.22
			
			// Rotacion y escala
			sceGumRotateX(-0.48f);
			sceGumRotateY(-1.47+sinf(animDest)*-0.3+PI);
			sceGumRotateZ(-3.13-sinf(animDest)*1.4);

			// Escala (Hago esto solo para que las espadas sean mas grandes que los demas items)
    ...
    else
    {
        ...
        {
            invSprite->Draw();
			tapSe->SetPosition(167+creativePlace*30,70);
			tapSe->Draw();
        }
        if (craft3xEn == true)
        {
    ...
    if(craft3xEn == true)
    {
        for(int i = 0; i <= 2; i++)
        {
            for(int j = 0; j <= 2; j++)
            {
                if(craftSlotId3[i*3+j] != -1)
                {
                    ...
                    MatrixTranslation(Vector3(204+j*18,78+i*18,0.0f));
        ...
        if (craftItemId3 != -1)
        {
            ...
            MatrixTranslation(Vector3(298,96,0.0f));
    ...
    if (invEn == true || craft3xEn == true || chestEn == true || furnaceEn == true)
    {
        for(int k = 0; k <= 8; k++)
        {
            if(mWorld->invId[27+k] != -1)
            {
                ...
                {
                    ScePspFVector3 loc = {168+k*18,203,0.0f};
                    sceGumTranslate(&loc);
                }
            ...
            for(int i = 0; i <= 2; i++)
            {
                for(int j = 0; j <= 8; j++)
                {
                    if(mWorld->invId[i*9+j] != -1)
                    {
                        ...
                        ScePspFVector3 loc = {168+j*18,149+i*18,0.0f};
                        sceGumTranslate(&loc);
        ...
        if (mWorld->mId != -1) //MOUSE ITEM
        {
            ...
            else
            {
                if(invEn == false)
                {
                    ScePspFVector3 loc = {168 + (invXPosition * 18),145+(invYPosition*18),0.0f};
                    sceGumTranslate(&loc);
                }
                else
                {
            ...
            for(int j = 0; j <= 2; j++)
            {
                if(craftSlotId3[i*3+j] >= 250 && mWorld->DurabilityPointsItem(craftSlotId3[i*3+j]) != -1)
                {
                    if(craftSlotAm3[i*3+j] != mWorld->DurabilityPointsItem(craftSlotId3[i*3+j])) // checking durability
                    {
                        ...
                        toolPointSprite[toolPointStd]->SetPosition(198+j*18,83+i*18);
        ...
        if (mWorld->mId >= 250 && mWorld->DurabilityPointsItem(mWorld->mId) != -1)
        {
            if(mWorld->mAm != mWorld->DurabilityPointsItem(mWorld->mId))
            {
                ...
                if (upEn == 1)
                {
                    ...
                    if (craft3xEn == 1)
                    {
                        toolPointSprite[toolPointStd]->SetPosition(198+invXPosition*18,79+invYPosition*18);
                    }
                    if (chestEn == 1)
                    {
    ...
    if(invEn == true || craft3xEn == true || chestEn == true || furnaceEn == true)
    {
        ...
        if (mWorld->mId != -1)
        {
            ...
            if(canDraw == true)
            {
                ...
                else
                {
                    if(craft3xEn == 1)
                    {
                        DrawAmount(209+(invXPosition * 18),86+(invYPosition * 18),mWorld->mAm);
                    }
                    if(chestEn == 1)
                    {
        ...
        sliderSprite->SetPosition(332,slide_y);
        sliderLightedSprite->SetPosition(332,slide_y);
    ...
    if(craft3xEn == true)
    {
            ...
            for(int j = 0; j <= 2; j++)
            {
                if(craftSlotId3[i*3+j] != -1 && craftSlotAm3[i*3+j] > 1)
                {
                    if(craftSlotId3[i*3+j] >= 250)
                    {
                        ...
                        {
                            DrawAmount(209+j*18,91+i*18,craftSlotAm3[i*3+j]);
                        }
                    }
                    else
                    {
        ...
        if(craftItemId3 != -1)
        {
            if(craftItemId3 >= 250)
            {
                ...
                {
                    DrawAmount(303,109,craftItemAm3);
                }
            }
            else
            {
   ...
   if(invEn == true || craft3xEn == true || chestEn == true || furnaceEn == true)
    ...
    if(menuState == 1)
    {
        ...
        else
        {
            ...
            if(language == ENGLISH)
            {
                ...
                selectPos == 2 ? DrawText(240,119,GU_COLOR(1,1,0,1),default_size,"Achievements") : DrawText(240,119,GU_COLOR(1,1,1,1),default_size,"Achievements");
            ...
            if(language == RUSSIAN)
            {
               //mRender->DebugPrint(2,15,"Sid mira: %i",mWorld->worldSeed);
                ...
                selectPos == 2 ? DrawText(240,119,GU_COLOR(1,1,0,1),default_size,"Logros") : DrawText(240,119,GU_COLOR(1,1,1,1),default_size,"Logros");
    ...
    if (menuState == 3)
    {
        if(language == ENGLISH)
        {
            DrawText(240,24,GU_COLOR(1,1,1,1),default_size,"No Yet!!");
        }
        if(language == RUSSIAN)
        {

            DrawText(240,24,GU_COLOR(1,1,1,1),default_size,"No Disponible!!");
        }
    }
    ...
    if(devMode)
    {
		...
		mRender->DebugPrint(20,214,"sprint bool condition %i",sprint);
