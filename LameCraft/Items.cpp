...
SkeletonEGG::SkeletonEGG():BaseItem()
{
	textureRow = 1;
	plane = 8;
...
item_t SkeletonEGG::getID(){ return 411;}
...
item_t Bow3::getID(){ return 414;}

Shield::Shield():BaseItem()
{
	textureRow = 6;
	plane = 5;
	stackable = false;
...
item_t Shield::getID(){ return 415;}

NetherQuartz::NetherQuartz():BaseItem()
{
	textureRow = 8;
	plane = 13;
...
item_t NetherQuartz::getID(){ return 416;}

PigmanEGG::PigmanEGG():BaseItem()
{
	textureRow = 1;
	plane = 9;
...
item_t PigmanEGG::getID(){ return 417;}

GlowstoneDust::GlowstoneDust():BaseItem()
{
	textureRow = 8;
	plane = 12;
...
item_t GlowstoneDust::getID(){ return 418;}

WitherSkeletonEGG::WitherSkeletonEGG():BaseItem()
{
	textureRow = 1;
	plane = 10;

	name = "Wither Skeleton EGG";
}

item_t WitherSkeletonEGG::getID(){ return 419;}

VillagerEGG::VillagerEGG():BaseItem()
{
	textureRow = 1;
	plane = 11;
...
item_t VillagerEGG::getID(){ return 420;}

WolfEGG::WolfEGG():BaseItem()
{
	textureRow = 1;
	plane = 12;
...
item_t WolfEGG::getID(){ return 421;}

Emerald::Emerald():BaseItem()
{
	textureRow = 13;
	plane = 6;
...
item_t Emerald::getID(){ return 422;}
